  ...
  <div class="p-2">
      ...
      <div v-show="showSearch" class="mb-[10px]">
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
            ...
            <el-form-item label="操作人员" prop="createdByName">
              <el-input v-model="queryParams.createdByName" placeholder="请输入操作人员" clearable @keyup.enter="handleQuery" />
            </el-form-item>
    ...
    <el-card shadow="hover">
      ...
      <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="创建者" align="center" prop="createdByName" width="100" />
