  ...
  <div class="p-15">
    <div class="p-card">
      <el-row :gutter="10" style="margin-bottom: 10px">
        <el-col :span="1.5">
          <el-button v-hasPermi="['system:post:add']" link icon="Plus" @click="handleAdd">新增</el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button v-hasPermi="['system:post:edit']" link icon="Edit" :disabled="single" @click="handleUpdate()">修改</el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button v-hasPermi="['system:post:remove']" link icon="Delete" :disabled="multiple" @click="handleDelete()"> 删除 </el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button v-hasPermi="['system:post:export']" link icon="Download" @click="handleExport">导出</el-button>
        </el-col>
      </el-row>
        ...
        <el-table-column label="操作" width="180" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-tooltip content="修改" placement="top">
              <el-button v-hasPermi="['system:post:edit']" link icon="Edit" @click="handleUpdate(scope.row)"></el-button>
            </el-tooltip>
            <el-tooltip content="删除" placement="top">
              <el-button v-hasPermi="['system:post:remove']" link icon="Delete" @click="handleDelete(scope.row)"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
...
const handleDelete = async (row?: PostVO) => {
  ...
  await proxy?.$modal.confirm('是否确认删除岗位编号为"' + ids + '"的数据项？');
  await delPost(ids);
  await getList();
