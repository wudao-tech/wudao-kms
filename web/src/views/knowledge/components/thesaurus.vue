<template>
    <div class="setting-content">
        <div class="thesaurus-content" style="background-color: #fff; height: 100%;">
            ...
            <div class="dictionary-tabs" style="padding: 0 10px;">
                        ...
                        <template #label>
                            <div style="position: relative;">
                                ...
                                <el-tooltip :content="item.description" placement="top">
                                    <el-icon style="color:#D8D8D8; font-size: 12px; margin-left: 2px; position: absolute; right: -12px; top: 0;"><question-filled /></el-icon>
                                </el-tooltip>
                            </div>
                        </template>
                    </el-tab-pane>
                ...
                <div style="display: flex;align-items: center; justify-content: space-between;">
                    ...
                    <div style="display: flex; align-items: center; gap: 10px;">
                        <el-button  type="primary" @click="thesaurusSearch">搜索</el-button>
                        <el-button type="primary" icon="Plus" :disabled="permissionType === 3" @click="dialogVisible = true">添加</el-button>
                        <el-upload
                            ref="uploadRef"
                        ...
                        >
                            <el-button plain :loading="importLoading" icon="Upload" :disabled="permissionType === 3">导入</el-button>
                        </el-upload>
                        <el-button icon="Download" :loading="exportLoading" :disabled="permissionType === 3" @click="exportWordLibraryFn">
                            导出
                        </el-button>
                    </div>
                </div>
            ...
            <div style="padding: 0 10px;">
                <el-table :data="dictionaryData" style="width: 100%; margin-top: 10px;" :max-height="maxHeight" border>
                    ...
                    <el-table-column label="操作" width="150">
                        <template #default="scope">
                            <el-tooltip content="编辑" placement="top">
                                <el-button link  icon="EditPen" :disabled="permissionType === 3" size="small" @click="handleEdit(scope.row)"></el-button>
                            </el-tooltip>
                            <el-tooltip content="删除" placement="top">
                                <el-button link  icon="Delete" :disabled="permissionType === 3" size="small" @click="handleDelete(scope.row)"></el-button>
                            </el-tooltip>
                        </template>
                    </el-table-column>
                </el-table>
...
import { importWordLibrary } from '@/api/retrieve'
...
// 导入相关方法
const getCurrentDictTypeLabel = () => {
    const currentTab = tabOption.value.find(item => item.value === thesaurusParams.value.dictType)
    return currentTab ? currentTab.label : '未知类型'
}
...
watch(() => props.spaceId, (newVal) => {
    if (newVal) {
        ...
        total.value = 0
        thesaurusParams.value.dictKey = ''
        thesaurusParams.value.dictValue = ''
        time.value = []
        
        // 重新设置参数
        thesaurusParams.value.spaceId = newVal
        form.value.spaceId = newVal
...
onMounted(() => {
    thesaurusSearch()
    let height = document.querySelector('.thesaurus-content').clientHeight
