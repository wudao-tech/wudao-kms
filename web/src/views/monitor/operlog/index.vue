<template>
  <div class="p-15 lsd" style="height: 100%">
    ...
    <div style="background: #fff; padding: 20px; flex: 1">
      <div style="margin-bottom: 10px">
        <el-button link v-hasPermi="['monitor:operlog:remove']" type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete()">
          删除
        </el-button>
        <el-button link v-hasPermi="['monitor:operlog:remove']" type="danger" plain icon="WarnTriangleFilled" @click="handleClean">清空</el-button>

        <el-button link v-hasPermi="['monitor:operlog:export']" type="warning" plain icon="Download" @click="handleExport">导出</el-button>
      </div>
        ...
        <el-row>
          ...
          <el-col :span="24">
            ...
            <!-- <el-form-item label="请求参数：">
              <json-viewer :value="JSON.parse(form.operParam)" :expand-depth="1" copyable sort></json-viewer>
            </el-form-item> -->
          ...
          <el-col :span="24">
            ...
            <!-- <el-form-item label="返回参数：">
              <json-viewer :value="JSON.parse(form.jsonResult)" :expand-depth="1" copyable sort></json-viewer>
            </el-form-item> -->
          </el-col>
          <el-col :span="6">
