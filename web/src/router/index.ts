...
export const constantRoutes: RouteRecordRaw[] = [
  ...
  {
    path: '/login',
    component: () => import('@/views/new_login.vue'),
    hidden: true
  },
  {
    path: '/callback',
  ...
  },
  {
    ...
    // component: () => import('@/views/new_register.vue'),
    hidden: true
  },
  {
    path: '/:pathMatch(.*)*',
    ...
    children: [ 
      {
        ...
        meta: { title: '知识问答', activeMenu: '/home/specialist', icon: '' }
      },
      {
        path: '/space/specialist/config',
        component: () => import('@/views/specialist/config.vue'),
        name: 'SpecialistConfig',
        meta: { title: '知识配置', activeMenu: '/home/specialist', icon: '' }
      }
    ]
  },
  {
    ...
    children: [ 
      {
        ...
        component: () => import('@/views/retrieve/detail.vue'),
        name: 'RetrieveDetail',
        meta: { title: '详情', activeMenu: '/space/retrieve', icon: '' }
      }
    ]
  },
  {
