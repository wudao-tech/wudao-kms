    ...
    getWeekArr(rule) {
      ...
      if (this.dayRule == '' && this.dayRuleSup == '') {
        if (rule.indexOf('-') >= 0) {
          ...
          //   this.dayRuleSup[1] = 0
          // }
          this.dayRuleSup[i] = this.dayRuleSup[i] - 1; // 0 0 0 ? * 1    这里的1即代表0【星期天】--修改2024/03/07
        ...
        if (this.dayRule == 'weekDay') {
          for (let i = 0; i < this.dayRuleSup.length; i++) {
            // if (this.dayRuleSup[i] == 7) {  // 如果weekDay时将7调整为0【week值0即是星期日】
            //   this.dayRuleSup[i] = 0
            // }
            this.dayRuleSup[i] = this.dayRuleSup[i] - 1; // 0 0 0 ? * 1    这里的1即代表0【星期天】--修改2024/03/07
          }
