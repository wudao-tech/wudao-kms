<template>
  <el-drawer v-model="showSettings" :with-header="false" direction="rtl" size="300px" close-on-click-modal>
    ...
    <div style="font-size: 12px; color: #999; margin-top: 5px; padding: 0 12px;">
      <el-icon style="margin-right: 4px;"><InfoFilled /></el-icon>
      深色模式会覆盖系统设置，您可以手动切换主题
    </div>
...
const predefineColors = ref(['#6B05A8', '#ff4500', '#ff8c00', '#ffd700', '#90ee90', '#00ced1', '#1e90ff', '#c71585']);
...
// 强制初始化为明亮模式，避免Mac系统深色模式的自动检测
onMounted(() => {
  // 如果本地存储中没有用户的主题偏好，强制设置为明亮模式
